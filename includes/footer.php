  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-6 col-lg-2">
        ...
        <ul class="footer-links">
          <li><a href="<?= url('privacy_policy.txt') ?>">Privacy Policy</a></li>
          <li><a href="<?= url('membership_terms.txt') ?>">Terms of Service</a></li>
        </ul>
      </div>
    </div>
...
<script>const rootPath='<?= url('') ?>';const csrfToken='<?= csrfToken() ?>';</script>
